...
class G1 : public G
{
  public:
    ...
    G1(const Pairing & e, const unsigned char * data, unsigned short len, bool compressed = false, unsigned short base = 16);
    ...
    G1 & operator^=(const Zr & exp)
    {
        return (G1 &)G::operator^=(exp);
    }
