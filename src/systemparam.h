...
{
  public:
    SystemParam(const char * pairingParamFileStr = "pairing.param", const char * sysParamFileStr = "system.param");
    ...
    void set_f(NodeID threshold)
    {
        f = threshold;
    }
    const G1 & get_U() const
    {
        return U;
    }
    const Pairing & get_Pairing() const
    {
        return e;
    }
