...
{ // Ring
  public:
    ...
    Zr(const Pairing & e, const unsigned char * data, unsigned short len, unsigned short base = 16);
    ...
    void dump(FILE * f, const char * label = NULL, unsigned short base = 16) const;
