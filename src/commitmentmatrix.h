...
class CommitmentMatrix
{
  ...
  public:
    ...
    unsigned short getRowCnt() const
    {
        return (unsigned short)entries.size();
    }
    unsigned short getRowWidth(unsigned short rowIndex) const
    {
        return (unsigned short)entries[rowIndex].size();
    }
