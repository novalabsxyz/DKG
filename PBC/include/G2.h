...
class G2 : public G
{
  public:
    ...
    G2(const Pairing & e, const unsigned char * data, unsigned short len, bool compressed = false, unsigned short base = 16);
    ...
    G2 & operator^=(const Zr & exp)
    {
        return (G2 &)G::operator^=(exp);
    }
